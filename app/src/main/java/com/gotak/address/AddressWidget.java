...
public class AddressWidget extends AbstractWidgetMapComponent implements
    ...
    public static final String TAG = "AddressWidget";
    ...
    private final BroadcastReceiver wacky = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (widget == null) {
                ...
                widget.addOnClickListener(AddressWidget.this);
                widget.addOnPressListener(AddressWidget.this);
                widget.addOnUnpressListener(AddressWidget.this);
                widget.addOnMoveListener(AddressWidget.this);
