...
public class SpeechToTextActivity extends Activity {
    ...
    private static final String SPEECH_INFO = "com.atackmap.android.Address.SPEECHINFO";
    private static final String ALPHA_VALIDATOR = "com.atackmap.android.Address.ALPHA_VALIDATOR";
    private static final String DIGIT_VALIDATOR = "com.atackmap.android.Address.DIGIT_VALIDATOR";
    private static final String MARKER_VALIDATOR = "com.atackmap.android.Address.MARKER_VALIDATOR";
