 ...
 * Needs to be its own class because you can't access AtakBroadcast inside AddressDropDownReceiver
...
public class SpeechDetailOpener {
     ...
     * @param view - view from the AddressDropDownReceiver. Needed to get the self marker. And to get the mapGroups
     */
