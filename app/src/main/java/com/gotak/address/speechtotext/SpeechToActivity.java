...
package com.gotak.address.speechtotext;
 ...
 * to the AddressDropDownReceiver.
 */
public class SpeechToActivity extends Activity {
    //These are the intents for AddressDropDownReceiver
    ...
    public static final String QUICK_INTENT = "com.gotak.address.QUICKINTENT";
    public static final String NAVIGATE_SPEECH_INFO = "com.gotak.address.NAVIGATESPEECHINFO";
    public static final String ACTIVITY_INFO_BUNDLE = "com.gotak.address.ACTIVITYINFOBUNDLE";
    public static final String DESTINATION = "com.gotak.address.DESTINATION";
    public static final String EMERGENCY_TYPE = "com.gotak.address.EMERGENCYTYPE";
    public static final String ACTIVITY_INTENT = "com.gotak.address.ACTIVITY";
     ...
     * activities bundle gets sent back to AddressDropDownReceiver
    ...
    /**
     * Sends out returnIntent back to AddressDropDownReceiver
     */
     ...
     * here(or there in AddressDropDownReceiver rather)
     *
     */
